...
def build_lasso_te200(seed: int = SEED) -> Pipeline:
    ...
    This is intentionally not added to MODEL_REGISTRY: it is a final-candidate
    variant of the linear model family, used by src.final_lb_candidates while
    keeping the report/model lineup capped.
    """
    return Pipeline(
        [
